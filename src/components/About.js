        ...
        <div className="row">
          <div className="col-lg-6 align-self">
            ...
            <p className="mt-lg-4 mt-3">
              Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices ligula. Semper at tempufddfel.
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Non quae, fugiat.
            </p>
            <p className="mt-3 mb-lg-5">
              Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices ligula. Semper at. Lorem ipsum
              dolor sit amet elit. Non quae.
            </p>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 align-self pr-lg-4">
            ...
            <div className="progress-info info2">
              <h6 className="progress-tittle">PHP programming <span className="">95%</span></h6>
              <div className="progress">
                <div
                  className="progress-bar progress-bar-striped"
                  role="progressbar"
          ...
          <div className="col-lg-6 mt-lg-0 mt-5 pl-lg-4">
            ...
            <p className="mt-md-4 mt-3">
              Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper at. Lorem ipsum
              dolor sit amet elit. Non quae, fugiat nihil ad. Lorem ipsum dolor sit amet. Lorem ipsum init dolor sit,
              amet elit. Dolor ipsum non velit, culpa! elit ut et.
            </p>
        ...
        <div className="row">
          <div className="col-lg-6 about-right-faq align-self">
            ...
            <p className="mt-lg-4 mt-3 mb-lg-5 mb-4">
              ...
              Lorem ipsum dolor sit amet elit. Non quae, fugiat libero ut justo, ultrices in ligula amet dolor sit
            </p>
